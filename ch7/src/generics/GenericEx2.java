...
public class GenericEx2 {
	...
	public static void main(String[] args) {
		...
		//ArrayList<Product> : ArryaList에 Product 타입만 추가
		//부모 - 자식 관계의 객체들은 부모타입으로 선언된 상태여도 자식의 객체를 담는 것이 가능
		...
		tvList.add(new Tv());
		tvList.add(new Tv());
//		tvList.add(new Product());(x) 부모는 담을 수 없음
//		tvList.add(new Audio());(x) 관계 없음(형제 관계라는건 없으)
